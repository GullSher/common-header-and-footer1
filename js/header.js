...
fetch("./header.html")
  ...
  .then((data) => {
    ...
    // Load header.css from correct GitHub Pages path
    if (!document.querySelector('link[href$="css/header.css"]')) {
      const link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = "./css/header.css"; // ✅ Relative to HTML page (works locally AND on GitHub)
  ...
  // to load header.html at github i am trying to commit header.js 
  // fetch("./header.html")
  // .then((response) => response.text())
  // .then((data) => {
  //   document.getElementById("header").innerHTML = data;
